...
<p>Interrupts are similarly specific and will be covered fairly soon, basically they consist of a two word (32 consecutive bits) part of the lower memory range that holds</p>
<ul>
